...
git clone https://github.com/baditaflorin/mesh-truth-bomb
cd mesh-truth-bomb
npm install
npm run dev
```
...
- `mesh-truth-bomb:signalingUrl`
- `mesh-truth-bomb:turnTokenUrl`
- `mesh-truth-bomb:iceServers`
- `mesh-truth-bomb:room`
